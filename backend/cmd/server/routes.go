...
func (app *application) routes() http.Handler {
	...
	router.HandlerFunc(http.MethodGet, "/api/estimation/room/:id/:username/permissions", app.handleFetchPermissions)
	...
	router.HandlerFunc(http.MethodGet, "/api/estimation/room/rooms", app.handleFetchActiveRooms)
